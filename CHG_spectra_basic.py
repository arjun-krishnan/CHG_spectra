...
class P_array:
    def __init__(self,n=100000,sigmae=0.0007,sigmax=4.69e-4,sigmaxp=4.58e-5,wl_L=800e-9,n_T=8):
        self.n_points= n
        self.sig_e= sigmae
        self.sig_x= sigmax
        self.sig_xp= sigmaxp
    ...
    def modulate(self,p_array_in,A,wl,w0=1000,phase=0):
...
p_in= P_array(n=int(5e4),n_T=10,wl_L=800e-9,sigmae=0.0007)
p_mod1=p_in.modulate(p_in.p_init,A=A,wl=800e-9,phase=2e10)

wls=np.linspace(180e-9,215e-9,1001)
hmap=[]
for R1 in tqdm(R56):
